...
for term in search_terms:
    try:
        ...
        result = asyncio.run(LiderScraper().search(term, limit=500))  # Pedir 500 para ver qué devuelve
...
for term in search_terms:
    try:
        ...
        result = asyncio.run(search_jumbo(term, limit=500))  # Pedir 500 para ver qué devuelve
